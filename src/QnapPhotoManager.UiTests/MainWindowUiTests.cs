...
namespace QnapPhotoManager.UiTests;
...
public sealed class MainWindowUiTests
{
    ...
    public void Startup_shows_safe_initial_state_and_blocks_destructive_actions()
    {
        ...
        try
        {
            ...
            Assert.Equal("Qnap Photo Manager", window.Title);
    ...
    {
        var executable = Path.Combine(AppContext.BaseDirectory, "QnapPhotoManager.exe");
